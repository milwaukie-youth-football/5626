...
- **H**: Fakes taking the ball — sells the misdirection, doesn't actually get it.
- **F**: Also gets faked to as part of the mesh, then releases to the backside flat as the checkdown, away from where the run hits.
...
- **Q**: Fakes the handoff to H only (no F in the backfield to fake to), then counters back, keeps the ball, and follows BG's kick and BT's wrap through the hole.
- **F**: Same job as Gold Duo/Trap — blocks the alley/force defender to his inside, protecting the edge instead of releasing as a backfield checkdown.
